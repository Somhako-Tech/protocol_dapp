...
export type GetProfileByHandleQuery = { __typename?: 'Query', getProfile?: { __typename?: 'Profile', id: number, handle: string, title: string, summary: string, job_type: string, pref_location: string, salary: string, years_of_exp: string, skills: Array<string>, experience: Array<any>, education: Array<any>, address: string, minted: boolean } | null };
