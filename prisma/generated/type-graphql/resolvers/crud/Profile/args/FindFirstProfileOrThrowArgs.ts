...
export class FindFirstProfileOrThrowArgs {
  ...
  distinct?: Array<"id" | "handle" | "title" | "summary" | "job_type" | "pref_location" | "salary" | "years_of_exp" | "link" | "address" | "skills" | "education" | "experience" | "minted" | "user_id" | "ipfs_hash" | "resume"> | undefined;
}
